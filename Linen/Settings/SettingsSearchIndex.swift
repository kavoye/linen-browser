...
enum SettingsIndex {
    ...
    static let all: [SettingsEntry] = [
        ...
        SettingsEntry("general.sleepTabs", .general, "Sleep inactive tabs",
                      "Frees memory when the Mac runs low. Tabs reload on return.",
        ...
        SettingsEntry("general.lyrics", .general, "Show lyrics",
                      "Only the song and artist go to LRCLIB, never from a private tab.",
                      ["lyrics", "words", "sing", "karaoke", "music", "song", "lrclib", "synced", "media", "player"]),
        SettingsEntry("general.agentOnly", .search, "Always ask the assistant", "Questions go to the assistant; links still open.",
        ...
        SettingsEntry("appearance.zoom", .appearance, "Page zoom", "The default for every website. Tabs can still be zoomed.",
        ...
        SettingsEntry("privacy.clear", .privacy, "Clear browsing data", "History, cookies, and cached files, over a time range.",
        ...
        SettingsEntry("privacy.quit", .privacy, "Clear on quit", "Cookies, site data, and cached files, on every quit.",
        ...
        SettingsEntry("assistant.linkPeek", .provider, "Summarize a link on hover",
                      "Hold Shift and point at a link to read the page first.",
        ...
        SettingsEntry("advanced.features", .advanced, "Feature flags",
                      "WebKit’s own experiments, which can break websites.",
                      ["webkit", "flags", "experimental", "features", "develop"]),
        SettingsEntry("advanced.certificates", .advanced, "Certificate exceptions", "Continue past a certificate macOS rejects. Forgotten on quit.",
