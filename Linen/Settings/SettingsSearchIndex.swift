...
enum SettingsIndex {
    ...
    static let all: [SettingsEntry] = [
        ...
        SettingsEntry("general.importSafari", .general, "Import from Safari", "Bookmarks and history.",
                      ["import", "safari", "bookmarks", "history", "migrate", "switch", "transfer"]),
        SettingsEntry("general.importChrome", .general, "Import from Chrome", "Bookmarks and history, from every profile.",
                      ["import", "chrome", "google", "bookmarks", "history", "migrate", "switch", "transfer"]),
        ...
        SettingsEntry("voice.readAloud", .voice, "Read aloud", "Speak answers as they arrive.",
                      ["speech", "speak", "mute", "voice", "aloud"]),
        SettingsEntry("voice.talk", .voice, "Push to talk", "Hold while speaking. Release to send.",
